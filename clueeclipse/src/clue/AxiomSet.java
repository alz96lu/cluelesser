...
public class AxiomSet {
	...
	Guess randomGuess() {
		return new Guess(suspects.get(Helper.random(suspects.size())), rooms.get(Helper.random(rooms.size())),
	...
	static void test() {
		...
		ax.add(new Or(new Has(new Weapon("Knife"), 1), new Has(new Room("Hall"), 1),
		...
		ax.add(new Or(new Has(new Weapon("Rope"), 1), new Has(new Room("Ballroom"), 1)));
		ax.add(new Or(new Has(new Suspect("Senator Scarlet"), 2), new Has(new Room("Ballroom"), 2)));
		...
		ax.addAndResolve(new Or(new Has(new Room("Ballroom"), 1), new Has(new Suspect("Justice Peacock"), 2)));
	...
	static void testcomplicated() {
		AxiomSet ax = new AxiomSet(5, new ArrayList<Card>());
		Tester t = new Tester();
		ax.add(new Or(new Has(new Weapon("Knife"), 1), new Has(new Suspect("Professor Plum"), 1)));
		ax.add(new Or(new Has(new Weapon("Knife"), 2), new Has(new Suspect("Professor Plum"), 2)));
		ax.addAndResolve(new Or(new Has(new Weapon("Knife"), 3), new Has(new Suspect("Professor Plum"), 3),
		...
		t.test(ax.defs.contains(new Definite(new Has(new Suspect("Professor Plum"), 1))),
				"shoud know that 1 has professor plum");
	}
