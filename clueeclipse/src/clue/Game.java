...
class Game {
	...
	public static List<Weapon> WEAPONS = Arrays.asList(new Weapon("Knife"), new Weapon("Rope"),
			new Weapon("Candlestick"), new Weapon("Revolver"), new Weapon("Wrench"), new Weapon("Lead Pipe"));
	public static List<Suspect> SUSPECTS = Arrays.asList(new Suspect("Senator Scarlet"), new Suspect("Colonel Mustard"),
			new Suspect("Reverend Green"), new Suspect("Professor Plum"), new Suspect("Justice Peacock"),
			new Suspect("Doctor White"));
	public static List<Room> ROOMS = Arrays.asList(new Room("Conservatory"), new Room("Billiards Room"),
			new Room("Ballroom"), new Room("Cellar"), new Room("Dining Room"), new Room("Kitchen"), new Room("Hall"),
			new Room("Library"), new Room("Lounge"), new Room("Study"));
