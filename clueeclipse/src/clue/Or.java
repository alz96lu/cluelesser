...
public class Or {
	...
	static void test() {
		...
		Or orr = new Or(new Has(new Weapon("Knife"), 1), 
				new Has(new Suspect("Senator Scarlet"),1),
		...
		Or orr2 = new Or(new Has(new Weapon("Knife"),1),
				new Has(new Room("Hall"),1),
	...
	// we know that the first is true - are any of the remainders necessarily untrue?
